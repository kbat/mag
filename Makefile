...
gam-solve: obj/solve.o obj/SDEF.o obj/Test.o obj/Source.o obj/Material.o obj/Solver.o obj/SolverArguments.o obj/functions.o
	@echo "Linking $@"
...
gam: obj/gam.o obj/SDEF.o obj/Source.o obj/Material.o obj/Solver.o obj/Optimiser.o obj/OptArguments.o obj/functions.o
	@echo "Linking $@"
